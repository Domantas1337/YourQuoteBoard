...
namespace YourQuoteBoard.Migrations
{
    ...
    [Migration("20240724113723_InitialCreate")]
            ...
            modelBuilder.Entity("YourQuoteBoard.Entity.Tag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TagId = new Guid("403bce12-b3ca-4745-bcb8-08e38e411b0f"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Inspirational"
                        },
                        new
                        {
                            TagId = new Guid("bca4ca01-34fc-416b-be7d-5e90a6383730"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Funny"
                        },
                        new
                        {
                            TagId = new Guid("a4b9965b-7cc4-478e-ac28-936b548fb9f8"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Philosophical"
                        },
                        new
                        {
                            TagId = new Guid("3888ad5d-d489-4403-b2df-9b3b068c8551"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Literary"
                        },
                        new
                        {
                            TagId = new Guid("2ea85663-d107-4cde-82e2-635271f562a7"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Sad"
                        },
                        new
                        {
                            TagId = new Guid("43a4a27d-3373-43ef-8d04-853d7e018c09"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Emotional"
                        },
                        new
                        {
                            TagId = new Guid("0241fa77-214c-44a8-abfe-8484ee7b849b"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Informative"
                        },
                        new
                        {
                            TagId = new Guid("ed5e0db3-3b6c-4e45-af44-530332949736"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Biography"
                        },
                        new
                        {
                            TagId = new Guid("b4a6b78b-f19a-4294-8a1f-01d136e72031"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Fiction"
                        },
                        new
                        {
                            TagId = new Guid("a882983b-70aa-497f-b3ad-5a819344b363"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Autobiography"
                        },
                        new
                        {
                            TagId = new Guid("3c0806f4-d592-489d-8490-19a20087985f"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Novel"
                        },
                        new
                        {
                            TagId = new Guid("767c6d3b-5b1a-4bd5-a953-aeaa7c0a942c"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Romantic"
                        },
                        new
                        {
                            TagId = new Guid("02710de8-8ad6-4ffa-a167-05797812b904"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Non_Fiction"
                        },
                        new
                        {
                            TagId = new Guid("a1fcb497-4e23-4706-9c6b-0f3b68caf786"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Comedy"
                        });
