...
namespace YourQuoteBoard.Migrations
{
    ...
    [Migration("20240806102117_detailedRating")]
    partial class detailedRating
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("YourQuoteBoard.Entity.Tag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TagId = new Guid("ec42e8b7-fc2c-4242-a905-cbf3d49631c3"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Inspirational"
                        },
                        new
                        {
                            TagId = new Guid("acddf115-450c-4227-98b3-49110ee8c207"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Funny"
                        },
                        new
                        {
                            TagId = new Guid("743ef06f-9f8c-4ffb-bf7e-37a4d844ffcb"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Philosophical"
                        },
                        new
                        {
                            TagId = new Guid("617de854-f7e2-4829-b886-ab914effac17"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Literary"
                        },
                        new
                        {
                            TagId = new Guid("6e82ea27-911e-44e9-858a-7f6eed909a95"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Sad"
                        },
                        new
                        {
                            TagId = new Guid("260e120a-e859-4340-b5b8-c9b332bf3bcb"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Emotional"
                        },
                        new
                        {
                            TagId = new Guid("351b1422-72cc-4b9f-946d-38c038c650c5"),
                            Discriminator = 0,
                            IsDefault = true,
                            Name = "Informative"
                        },
                        new
                        {
                            TagId = new Guid("daf61beb-b791-4b55-9415-c8941e78a754"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Biography"
                        },
                        new
                        {
                            TagId = new Guid("674cbc23-601a-4472-b72b-0b24f38b22c5"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Fiction"
                        },
                        new
                        {
                            TagId = new Guid("2c837ffb-5d90-4bc5-a6d4-7ac188dfec75"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Autobiography"
                        },
                        new
                        {
                            TagId = new Guid("a67f610d-6dcf-454c-b913-796b9f220ec9"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Novel"
                        },
                        new
                        {
                            TagId = new Guid("bb5eb928-6ad5-41f5-9f6f-d5e7f88b2ae0"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Romantic"
                        },
                        new
                        {
                            TagId = new Guid("b0ab7b41-9c8f-42a4-9509-b68c62d6840d"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Non_Fiction"
                        },
                        new
                        {
                            TagId = new Guid("75b2cab3-86a9-492a-a22a-931f65fcfe02"),
                            Discriminator = 1,
                            IsDefault = true,
                            Name = "Comedy"
                        });
